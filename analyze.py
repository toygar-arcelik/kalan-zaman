...
def updateSummarySheet(_ws, _machineno, _perf_df, _row, _column):
    ...
    temp, cupboarddryStopDoorTemp = findStartStopDoorTemp(testLog_df, 'state', 'RUN')
    ...
    _ws.cell(row=_row, column=excelColumnIndex['CUPBOARD DRY TIME']).value = elapsedTimeFinish - cupboarddryStartTime
